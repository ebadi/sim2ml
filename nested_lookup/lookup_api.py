...
def _call_callback(
    k, value_list, callback_function, function_parameters, conversion_function
):
    """
    ...
    for value in value_list:
        ...
        if function_parameters:
            trans_val = callback_function(k, value, *function_parameters)
        else:
            trans_val = callback_function(k, value)
    ...
    for key in keys:
        ...
        for k, v in findings.items():
            ...
            trans_val = _call_callback(
                k, v, callback_function, function_parameters, conversion_function
            )
